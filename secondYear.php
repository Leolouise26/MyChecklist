...
function applySearch() {
    ...
    if (visibleCount === 0) {
        ...
        secondYearChecklist.innerHTML = "<p><b>No matching second-year records found.</b></p>";
    } else {
        ...
        var existingSummaryRow = secondYearChecklist.querySelector(".summary-row");
        if (existingSummaryRow) {
            existingSummaryRow.innerHTML = summaryRow;
        } else {
            secondYearChecklist.querySelector("table").insertAdjacentHTML('beforeend', summaryRow);
        }
    }
}

function applySort(sortBy) {
    var table = document.querySelector("#second-year-checklist table");
