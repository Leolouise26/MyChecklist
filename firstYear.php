...
function applySearch() {
    ...
    if (visibleCount === 0) {
        ...
        var existingSummaryRow = firstYearChecklist.querySelector(".summary-row");
        if (existingSummaryRow) {
            existingSummaryRow.innerHTML = summaryRow;
        } else {
            firstYearChecklist.querySelector("table").insertAdjacentHTML('beforeend', summaryRow);
        }
    }
}

function applySort(sortBy) {
    var table = document.querySelector("#first-year-checklist table");
