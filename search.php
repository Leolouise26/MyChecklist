...
$rows_per_page = 9; // Number of rows per page
...
if (mysqli_num_rows($result) > 0) { // If there are results
    ...
    // Display the summary as a separate row
    echo "<tr>"; // Start the summary row
    echo "<td colspan='10'>Summary: Total matching records: " . $total_rows . "</td>"; // Display summary
    echo "</tr>"; // End the summary row
