...
function applySearch() {
    ...
    var thirdYearChecklist = document.getElementById("third-year-checklist");
    ...
    if (visibleCount === 0) {
        ...
        var existingSummaryRow = thirdYearChecklist.querySelector(".summary-row");
        if (existingSummaryRow) {
            existingSummaryRow.innerHTML = summaryRow;
        } else {
            thirdYearChecklist.querySelector("table").insertAdjacentHTML('beforeend', summaryRow);
        }
    }
}

function applySort(sortBy) {
    var table = document.querySelector("#third-year-checklist table");
